...
use rc_block_builder::BlockBuilderApi;
...
impl<'a, A> BlockBuilderExt for rc_block_builder::BlockBuilder<'a, substrate_test_runtime::Block, A>
where
	A: ProvideRuntimeApi<substrate_test_runtime::Block>
		+ rp_api::CallApiAt<substrate_test_runtime::Block>
		+ 'a,
