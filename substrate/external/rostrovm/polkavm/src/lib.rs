...
pub mod rostro_intrinsics {
    pub use crate::interpreter::{
        ...
        rostro_blake2b_256, rostro_bls381_g1_msm, rostro_bls381_g2_msm,
        rostro_bls381_pairing_check, rostro_dilithium_verify,
        rostro_ed25519_verify, rostro_keccak_256,
