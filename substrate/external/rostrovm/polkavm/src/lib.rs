...
pub mod rostro_intrinsics {
    pub use crate::interpreter::{
        MAX_BLS_MSM, MAX_BLS_PAIRS, MAX_MUL_PROJECTIVE_LIMBS,
        ...
        rostro_bandersnatch_sw_msm, rostro_bandersnatch_sw_msm_mont,
        rostro_bandersnatch_sw_mul_projective, rostro_bandersnatch_te_msm,
        rostro_bandersnatch_te_msm_mont, rostro_bandersnatch_te_mul_projective,
        rostro_blake2b_256, rostro_bls381_final_exponentiation,
        rostro_bls381_g1_msm, rostro_bls381_g1_msm_mont, rostro_bls381_g1_mul_projective,
        rostro_bls381_g2_msm, rostro_bls381_g2_msm_mont, rostro_bls381_g2_mul_projective,
        rostro_bls381_multi_miller_loop, rostro_bls381_pairing_check,
        rostro_dilithium_verify, rostro_ed25519_verify, rostro_keccak_256,
        rostro_p256_ecdsa_verify_prehash, rostro_p521_ecdsa_verify_prehash,
