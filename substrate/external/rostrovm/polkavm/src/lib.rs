...
pub mod rostro_intrinsics {
    pub use crate::interpreter::{
        ...
        rostro_bandersnatch_te_msm, rostro_bandersnatch_te_mul_projective,
        rostro_blake2b_256, rostro_bls381_final_exponentiation,
        rostro_bls381_g1_msm, rostro_bls381_g1_mul_projective,
        rostro_bls381_g2_msm, rostro_bls381_g2_mul_projective,
