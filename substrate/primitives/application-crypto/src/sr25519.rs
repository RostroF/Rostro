...
pub use rp_core::sr25519::*;

mod app {
	crate::app_crypto!(super, rp_core::testing::SR25519);
}
...
impl RuntimePublic for Public {
	...
	fn all(key_type: KeyTypeId) -> crate::Vec<Self> {
		rp_io::crypto::sr25519_public_keys(key_type)
	}

	fn generate_pair(key_type: KeyTypeId, seed: Option<Vec<u8>>) -> Self {
		rp_io::crypto::sr25519_generate(key_type, seed)
	}

	fn sign<M: AsRef<[u8]>>(&self, key_type: KeyTypeId, msg: &M) -> Option<Self::Signature> {
		rp_io::crypto::sr25519_sign(key_type, self, msg.as_ref())
	}

	fn verify<M: AsRef<[u8]>>(&self, msg: &M, signature: &Self::Signature) -> bool {
		rp_io::crypto::sr25519_verify(signature, msg.as_ref(), self)
	}
	...
	fn generate_proof_of_possession(
		...
		rp_io::crypto::sr25519_sign(key_type, self, &proof_of_possession_statement)
	}
	...
	fn verify_proof_of_possession(
		...
		let proof_of_possession_statement = Pair::proof_of_possession_statement(owner);
		rp_io::crypto::sr25519_verify(&proof_of_possession, &proof_of_possession_statement, &self)
	}
