...
pub use rp_core::paired_crypto::ecdsa_bls381::*;
use rp_core::{
	bls381,
	crypto::CryptoType,
	ecdsa, ecdsa_bls381,
...
mod app {
	crate::app_crypto!(super, rp_core::testing::ECDSA_BLS381);
}
...
impl RuntimePublic for Public {
	...
	fn generate_pair(key_type: KeyTypeId, seed: Option<Vec<u8>>) -> Self {
		rp_io::crypto::ecdsa_bls381_generate(key_type, seed)
	}
...
fn generate_ecdsa_proof_of_possession(
	...
	rp_io::crypto::ecdsa_sign(key_type, &ecdsa_pub, &proof_of_possession_statement)
}
...
fn generate_bls381_proof_of_possession(
	...
	rp_io::crypto::bls381_generate_proof_of_possession(key_type, &bls381_pub, owner)
}
...
mod tests {
	use super::*;
	use rp_core::{bls381, crypto::Pair, ecdsa};
