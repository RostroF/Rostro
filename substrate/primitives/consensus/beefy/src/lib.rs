...
pub use rp_application_crypto::key_types::BEEFY as KEY_TYPE;
use rp_application_crypto::{AppPublic, RuntimeAppPublic};
use rp_core::H256;
#[cfg(feature = "std")]
...
pub trait BeefyAuthorityId: RuntimeAppPublic {
	...
	fn try_sign_with_store(
		...
		store: KeystorePtr,
		msg: &[u8],
	) -> Result<Option<impl AsRef<[u8]> + Debug>, rp_keystore::Error>;
...
pub mod ecdsa_crypto {
	...
	#[cfg(feature = "std")]
	use core::fmt::Debug;
	use rp_application_crypto::{app_crypto, ecdsa};
	use rp_core::crypto::Wraps;
	#[cfg(feature = "std")]
	use rp_core::ByteArray;
	use rp_crypto_hashing::keccak_256;
	#[cfg(feature = "std")]
	use rp_keystore::KeystorePtr;
...
pub mod bls_crypto {
	...
	#[cfg(feature = "std")]
	use core::fmt::Debug;
	use rp_application_crypto::{app_crypto, bls381};
	use rp_core::{bls381::Pair as BlsPair, crypto::Wraps, ByteArray, Pair as _};
	#[cfg(feature = "std")]
	use rp_keystore::KeystorePtr;
...
pub mod ecdsa_bls_crypto {
	...
	#[cfg(feature = "std")]
	use core::fmt::Debug;
	use rp_application_crypto::{app_crypto, ecdsa_bls381};
	use rp_core::{crypto::Wraps, ecdsa_bls381::Pair as EcdsaBlsPair, ByteArray};
	#[cfg(feature = "std")]
	use rp_keystore::KeystorePtr;
...
pub const BEEFY_ENGINE_ID: rp_runtime::ConsensusEngineId = *b"BEEF";
...
mod tests {
	use super::*;
	use rp_application_crypto::ecdsa::{self, Public};
	use rp_core::crypto::{Pair, Wraps};
	use rp_crypto_hashing::keccak_256;
