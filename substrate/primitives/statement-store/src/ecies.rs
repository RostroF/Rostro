...
/// matching secret key.
pub fn encrypt_ed25519(pk: &rp_core::ed25519::Public, plaintext: &[u8]) -> Result<Vec<u8>, Error> {
...
pub fn decrypt_ed25519(pair: &rp_core::ed25519::Pair, encrypted: &[u8]) -> Result<Vec<u8>, Error> {
