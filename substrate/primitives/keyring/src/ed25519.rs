...
pub use rp_core::ed25519;

use crate::ParseKeyringError;
#[cfg(feature = "std")]
use rp_core::ed25519::Signature;
use rp_core::{
	ed25519::{Pair, Public},
	hex2array, ByteArray, Pair as PairT, H256,
};
use rp_runtime::AccountId32;
...
impl From<Keyring> for rp_runtime::MultiSigner {
	fn from(x: Keyring) -> Self {
		rp_runtime::MultiSigner::Ed25519(x.into())
	}
}
...
mod tests {
	use super::*;
	use rp_core::{ed25519::Pair, Pair as PairT};
