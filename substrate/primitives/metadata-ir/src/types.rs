...
pub struct OuterEnumsIR<T: Form = MetaForm> {
	...
	/// [`DispatchError::Module`](https://docs.rs/rp-runtime/24.0.0/rp_runtime/enum.DispatchError.html#variant.Module) variant.
	///
	...
	/// # Note
	///
	/// - This type cannot be used directly to decode `rp_runtime::DispatchError` from the chain.
	///   It provides just the information needed to decode `rp_runtime::DispatchError::Module`.
