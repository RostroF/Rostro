...
//! ```rust
//! assert_eq!(
//! 	rp_crypto_hashing_proc_macro::blake2b_256!(b"test"),
//! 	rp_crypto_hashing::blake2_256(b"test"),
//! );
//! assert_eq!(
//! 	rp_crypto_hashing_proc_macro::blake2b_256!([1u8]),
//! 	rp_crypto_hashing::blake2_256(&[1u8]),
//! );
//! assert_eq!(
//! 	rp_crypto_hashing_proc_macro::blake2b_256!([1, 2, 3]),
//! 	rp_crypto_hashing::blake2_256(&[1, 2, 3]),
//! );
//! assert_eq!(
//! 	rp_crypto_hashing_proc_macro::blake2b_256!(identifier),
//! 	rp_crypto_hashing::blake2_256(b"identifier"),
//! );
//! assert_eq!(
//! 	rp_crypto_hashing_proc_macro::blake2b_256!(identifier, b"/string"),
//! 	rp_crypto_hashing::blake2_256(b"identifier/string"),
//! );
//! ```
