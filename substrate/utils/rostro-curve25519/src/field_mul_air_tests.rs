...
use crate::field_mul_air::{
	...
	COL_MUL_B_HI, COL_MUL_B_LO, COL_MUL_CARRY, COL_MUL_CARRY_HI, COL_MUL_CARRY_LO, COL_MUL_WIDE,
	COL_MUL_WIDE_HI, COL_MUL_WIDE_LO, FIELD_MUL_M1_NUM_COLS, NUM_COLS_SCHOOLBOOK, WIDE_NUM_LIMBS,
};
...
fn run_eval(row: &[Goldilocks]) {
	assert_eq!(row.len(), FIELD_MUL_M1_NUM_COLS);
