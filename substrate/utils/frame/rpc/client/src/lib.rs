...
//!
//! It exposes a `WebSocket JSON-RPC` client that implements the RPC interface in `rc-rpc-api`
...
//! # use rp_core::{H256, storage::StorageKey};
//!
//! #[tokio::main]
//! async fn main() {
//!
...
mod tests {
	use super::*;
	use rp_runtime::testing::{Block as TBlock, Header, MockCallU64, TestXt, H256};
	use std::sync::Arc;
