...
#[test]
#[ignore = "B3c — allocator-return-path trap: guest traps dereferencing host-returned pointer"]
fn hashing_blake2_256_via_pvm_guest_matches_host() {
	let (_, gas) = run_fixture_export("test_hashing_blake2_256");
	...
	assert!(gas > 0, "expected_u64={expected_u64:#x}");
}
...
#[test]
#[ignore = "B3c — test vector or arg-passing diagnosis pending alongside the hashing trap"]
fn crypto_ed25519_verify_via_pvm_guest_accepts_rfc8032_vector() {
