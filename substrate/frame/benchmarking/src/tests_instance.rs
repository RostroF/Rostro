...
fn ensure_correct_instance_is_selected() {
	...
	let state = rc_client_db::BenchmarkingState::<rp_runtime::traits::BlakeTwo256>::new(
		Default::default(),
		None,
		false,
		false,
	...
	let mut ext = rp_state_machine::Ext::new(&mut overlay, &state, None);
	rp_externalities::set_and_run_with_externalities(&mut ext, || {
