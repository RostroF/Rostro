...
use rp_core::{sr25519::Pair as SrPair, Pair};
use rp_runtime::{
	traits::{
...
pub mod pallet {
	...
	impl<T: Config<I>, I: 'static> Pallet<T, I> {
		...
		fn hold_and_freeze_count() -> Result<(), rp_runtime::TryRuntimeError> {
		...
		fn account_frozen_greater_than_locks() -> Result<(), rp_runtime::TryRuntimeError> {
		...
		fn account_frozen_greater_than_freezes() -> Result<(), rp_runtime::TryRuntimeError> {
