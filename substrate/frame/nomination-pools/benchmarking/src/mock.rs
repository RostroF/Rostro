...
impl Convert<Balance, rp_core::U256> for BalanceToU256 {
	fn convert(n: Balance) -> rp_core::U256 {
		n.into()
	}
}

pub struct U256ToBalance;
impl Convert<rp_core::U256, Balance> for U256ToBalance {
	fn convert(n: rp_core::U256) -> Balance {
		n.try_into().unwrap()
	}
}
