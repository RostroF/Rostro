...
use rp_core::{ConstU16, ConstU32, ConstU64, H256};
use rp_runtime::{
...
impl crate::WeightInfo for MockWeights {
	fn under_alias() -> rp_runtime::Weight {
		Weight::from_parts(3, 3)
	}

	fn set_alias_account() -> rp_runtime::Weight {
		Weight::from_parts(4, 4)
	}

	fn unset_alias_account() -> rp_runtime::Weight {
		Weight::from_parts(5, 5)
	}

	fn reset_root() -> rp_runtime::Weight {
		Weight::from_parts(6, 6)
	}

	fn force_recognize_personhood() -> rp_runtime::Weight {
		Weight::from_parts(7, 7)
	}

	fn set_personal_id_account() -> rp_runtime::Weight {
		Weight::from_parts(8, 8)
	}

	fn unset_personal_id_account() -> rp_runtime::Weight {
		Weight::from_parts(9, 9)
	}

	fn set_onboarding_size() -> rp_runtime::Weight {
		Weight::from_parts(10, 10)
	}

	fn merge_rings() -> rp_runtime::Weight {
		Weight::from_parts(11, 11)
	}

	fn migrate_included_key() -> rp_runtime::Weight {
		Weight::from_parts(12, 12)
	}

	fn migrate_onboarding_key() -> rp_runtime::Weight {
		Weight::from_parts(13, 13)
	}

	fn should_build_ring(n: u32) -> rp_runtime::Weight {
		Weight::from_parts(n as u64 * 14, n as u64 * 14)
	}

	fn build_ring(n: u32) -> rp_runtime::Weight {
		Weight::from_parts(n as u64 * 14, n as u64 * 14)
	}

	fn onboard_people() -> rp_runtime::Weight {
		Weight::from_parts(15, 15)
	}

	fn remove_suspended_people(n: u32) -> rp_runtime::Weight {
	...
	fn migrate_keys_single_included_key() -> rp_runtime::Weight {
		Weight::from_parts(17, 17)
	}

	fn merge_queue_pages() -> rp_runtime::Weight {
		Weight::from_parts(18, 18)
	}

	fn on_poll_base() -> rp_runtime::Weight {
		Weight::from_parts(19, 19)
	}

	fn on_idle_base() -> rp_runtime::Weight {
...
pub fn exec_tx(
	...
	with_transaction(|| {
		...
		rp_runtime::TransactionOutcome::Rollback(Result::<_, DispatchError>::Ok(valid))
	})
	.unwrap()?;
...
pub fn setup_alias_account(
	...
	let msg = (&EXTENSION_VERSION, &call, &other_tx_ext).using_encoded(rp_io::hashing::blake2_256);
	let (proof, _alias) =
