...
use rp_core::crypto::key_types::DUMMY;
use rp_runtime::{
	impl_opaque_keys,
...
impl SessionHandler<u64> for TestSessionHandler {
	const KEY_TYPE_IDS: &'static [rp_runtime::KeyTypeId] = &[UintAuthorityId::ID];
...
impl crate::historical::Config for Test {
	...
	type FullIdentificationOf = rp_runtime::traits::ConvertInto;
}
