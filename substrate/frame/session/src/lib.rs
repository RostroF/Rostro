...
use rp_staking::{offence::OffenceSeverity, SessionIndex};
...
impl<AId> SessionHandler<AId> for TestSessionHandler {
	const KEY_TYPE_IDS: &'static [KeyTypeId] = &[rp_runtime::key_types::DUMMY];
...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		...
		///   [`impl_opaque_keys`](rp_runtime::impl_opaque_keys) for more information about the
		///   proof format.
		#[pallet::call_index(0)]
