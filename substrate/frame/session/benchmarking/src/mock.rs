...
use rp_runtime::{traits::IdentityLookup, BuildStorage, KeyTypeId};
...
rp_runtime::impl_opaque_keys! {
	pub struct SessionKeys {
		pub foo: rp_runtime::testing::UintAuthorityId,
	}
}
...
impl pallet_session::SessionHandler<AccountId> for TestSessionHandler {
	...
	fn on_genesis_session<Ks: rp_runtime::traits::OpaqueKeys>(_validators: &[(AccountId, Ks)]) {}
...
impl onchain::Config for OnChainSeqPhragmen {
	type System = Test;
	type Solver = SequentialPhragmen<AccountId, rp_runtime::Perbill>;
