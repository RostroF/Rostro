...
use rp_runtime::traits::MaybeSerialize;
...
rp_api::decl_runtime_apis! {
        ...
        AccountId: Decode + Encode + MaybeSerialize,
    {
        ...
        fn lookup(id: DomainHash, record_types: rp_std::vec::Vec<RecordType>) -> rp_std::vec::Vec<(RecordType, rp_std::vec::Vec<u8>)>;
        ...
        fn resolve_name(name: rp_std::vec::Vec<u8>) -> Option<NameRecord<AccountId, Duration, Balance>>;
        /// Return the active marketplace listing for a plain label (e.g. b"alice"), or `None` if not listed.
        fn get_listing(name: rp_std::vec::Vec<u8>) -> Option<ListingInfo<AccountId, Balance, Duration>>;
        ...
        fn lookup_by_name(name: rp_std::vec::Vec<u8>, record_types: rp_std::vec::Vec<RecordType>) -> rp_std::vec::Vec<(RecordType, rp_std::vec::Vec<u8>)>;
    }
}