	...
	quote! {
		...
		trait InherentDataExt {
			fn create_extrinsics(&self) ->
				#scrate::__private::Vec<<#block as #scrate::rp_runtime::traits::Block>::Extrinsic>;
			fn check_extrinsics(
				&self,
				block: &<#block as #scrate::rp_runtime::traits::Block>::LazyBlock
		...
		impl InherentDataExt for #scrate::inherent::InherentData {
				...
				#scrate::inherent::CheckInherentsResult
			{
				...
				use #scrate::rp_runtime::traits::{Block as _, ExtrinsicCall, LazyBlock};
				use #scrate::__private::{rp_inherents::Error, log};
				...
				for maybe_xt in block.extrinsics() {
					...
					if !(#scrate::rp_runtime::traits::ExtrinsicLike::is_bare(&xt)) {
						break
					}
		...
		impl #scrate::traits::IsInherent<<#block as #scrate::rp_runtime::traits::Block>::Extrinsic> for #runtime {
			fn is_inherent(ext: &<#block as #scrate::rp_runtime::traits::Block>::Extrinsic) -> bool {
				use #scrate::inherent::ProvideInherent;
				use #scrate::traits::IsSubType;
				use #scrate::rp_runtime::traits::ExtrinsicCall;

				let is_bare = #scrate::rp_runtime::traits::ExtrinsicLike::is_bare(ext);
				if !is_bare {
