...
/// * implement the trait `rp_runtime::BuildStorage`
pub fn expand_genesis_build(def: &mut Def) -> proc_macro2::TokenStream {
	...
	quote::quote_spanned!(genesis_build.attr_span =>
		#frame_support::std_enabled! {
			impl<#type_impl_gen> #frame_support::rp_runtime::BuildStorage for #gen_cfg_ident<#gen_cfg_use_gen> #where_clause
			{
				fn assimilate_storage(&self, storage: &mut #frame_support::rp_runtime::Storage) -> std::result::Result<(), std::string::String> {
