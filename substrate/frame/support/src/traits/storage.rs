...
pub use rp_core::storage::TrackedStorageKey;
use rp_core::Get;
use rp_runtime::{
...
pub trait StorageInstance {
	...
	fn pallet_prefix_hash() -> [u8; 16] {
		rp_io::hashing::twox_128(Self::pallet_prefix().as_bytes())
	}
	...
	fn storage_prefix_hash() -> [u8; 16] {
		rp_io::hashing::twox_128(Self::STORAGE_PREFIX.as_bytes())
	}
...
where
	Base: Get<Balance>,
	Slope: Get<Balance>,
	Balance: From<u64> + rp_runtime::Saturating,
{
