...
//! Helper functions for implementing [`rp_genesis_builder::GenesisBuilder`] for runtimes.
//!
//! Provides common logic. For more info refer to [`rp_genesis_builder::GenesisBuilder`].
...
/// more info refer to [`rp_genesis_builder::GenesisBuilder::build_state`].
...
/// to [`rp_genesis_builder::GenesisBuilder::get_preset`].
