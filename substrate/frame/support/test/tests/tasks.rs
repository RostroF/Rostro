...
type AccountId = u64;
type Header = rp_runtime::generic::Header<BlockNumber, rp_runtime::traits::BlakeTwo256>;
type UncheckedExtrinsic = rp_runtime::generic::UncheckedExtrinsic<u32, RuntimeCall, (), ()>;
type Block = rp_runtime::generic::Block<Header, UncheckedExtrinsic>;
