...
impl StateUsageStats {
	...
	pub fn merge_sm(&self, info: rp_state_machine::UsageInfo) {
	...
	pub fn take(&self) -> rp_state_machine::UsageInfo {
		use rp_state_machine::UsageUnit;
