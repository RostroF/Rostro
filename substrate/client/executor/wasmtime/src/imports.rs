...
use rc_executor_common::error::WasmError;
use rp_wasm_interface::{FunctionContext, HostFunctions};
...
impl<'a, 'b> rp_wasm_interface::HostFunctionRegistry for Registry<'a, 'b> {
