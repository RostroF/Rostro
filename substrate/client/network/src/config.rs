...
pub use rc_network_types::{build_multiaddr, ed25519};
...
/// use rc_network::config::parse_str_addr;
...
pub enum TransportConfig {
	...
	Normal {
		...
		/// been passed in `::rc_network::config::NetworkConfiguration::boot_nodes`.
...
pub struct NonDefaultSetConfig {
	...
	/// `rc_network::protocol::event::Event::NotificationStreamOpened::negotiated_fallback`
