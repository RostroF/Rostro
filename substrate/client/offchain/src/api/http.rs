...
use rp_core::offchain::{HttpError, HttpRequestId, HttpRequestStatus, Timestamp};
use std::{
	fmt,
	io::Read as _,
	pin::Pin,
...
mod tests {
	...
	use rp_core::offchain::{Duration, Externalities, HttpError, HttpRequestId, HttpRequestStatus};
